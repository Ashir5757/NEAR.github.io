...
<body>
    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="#" class="flex items-center">
                <span class="self-center text-2xl font-extrabold whitespace-nowrap dark:text-yellow-300">VENOM</span>
            </a>
                ...
                <ul
                        ...
                        <div id="dropdownNavbar"
                            ...
                            <div class="py-1">
                                <a href="{{ route("dashboard") }}"
                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">Dashbord</a>
                            </div>
                        </div>
                    </li>
                    ...
                    @guest
                        ...
                        @if (Route::has('register'))
                            <li class="nav-item">
                                <a class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
                                    aria-current="page" href="{{ route('register') }}">{{ __('Register') }}</a>
                            </li>
                        @endif
                    @else
                        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-1 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                     ...
                     document.getElementById('logout-form').submit();"
                        ...
                        {{-- <li class="nav-item dropdown">
                            <button  id="my-button" data-dropdown-toggle="my-dropdown" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                {{ Auth::user()->name }}
                            </button>
    ...
    {{-- HERO SEC --}}
    <section style="background-image: url('{{ asset('images/shubham-dhage-208asI7iZiU-unsplash.jpg') }}');"
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">We help you make
                    money by trading.</h2>
                <p class="mb-4">We are a team of experienced traders who have been in the industry for many years. We
                    know what it takes to make money in the markets, and we can teach you how to do it too.

                    We offer a variety of trading services, including:

                    Education: We offer a variety of educational resources to help you learn how to trade.
                    Signals: We provide real-time trading signals that you can use to make trades.
                    Account Management: We can manage your trading account for you, so you can focus on other things.
                    If you are serious about making money in the markets, then we can help you. Contact us today to
                    ...
                    Education, Signals, Account Management.

                    Contact us today.</p>
            </div>
            <div class="grid grid-cols-2 gap-4 mt-8">
                <img class="w-full rounded-lg" src="{{ asset('images/dylan-calluy-JpflvzEl5cg-unsplash.jpg') }}"
                    alt="office content 1">
                <img class="mt-4 w-full lg:mt-10 rounded-lg"
                    src="{{ asset('images/wance-paleri-LMgPRgkEiq4-unsplash.jpg') }}" alt="office content 2">
            </div>
        </div>

        <div class=" flex justify-center" >
            <div class=' w-full m-5 p-5 ' style="height : 600px">
                    <!-- TradingView Widget BEGIN -->


                    <div class="tradingview-widget-container">
                        <div id="tradingview_7d754"></div>
                        ...
                        <script type="text/javascript">
                            new TradingView.widget({
                                ...
                                "container_id": "tradingview_7d754"
                            });
                        </script>
                    </div>
        ...
        {{-- CRAD  COMPONENT --}}
        <div
            class="flex flex-wrap justify-content-center align-items-center grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-auto xl:grid-cols-auto auto-rows-max">
                ...
                <div
                    ...
                    <a href="#">
                        <img class="rounded-t-lg"
                            src="{{ asset('images/pierre-borthiry-peiobty-vBCVcWUyvyM-unsplash.jpg') }}"
                            alt="" />
                    </a>
                    <div class="p-5">
                        <a href="#">
